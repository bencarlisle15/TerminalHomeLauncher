    ...
    private enum Param implements com.bencarlisle15.terminalhomelauncher.commands.main.Param {
        ...
        default_app {
            ...
            public String exec(ExecutePack pack) {
                ...
                try {
                    XMLPrefsSave save = com.bencarlisle15.terminalhomelauncher.managers.xml.options.Apps.valueOf("default_app_n" + index);
...
//        },
        ...
        tutorial {
            ...
            @Override
            public String exec(ExecutePack pack) {
                pack.context.startActivity(Tuils.webPage("https://github.com/bencarlisle15/TerminalHomeLauncher/wiki/Apps"));
                return null;
            }
        };
