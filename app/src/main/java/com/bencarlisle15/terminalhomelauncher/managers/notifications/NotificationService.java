                    ...
                    if (queue != null) {
                        ...
                        while ((sbn = queue.poll()) != null) {
                            ...
                            if (bundle != null) {
                                ...
                                while (m.find()) {
                                    match = m.group(0);
                                    if (match != null && !match.startsWith(PKG) && !match.startsWith(APP) && !match.startsWith(NEWLINE) && !timePattern.matcher(match).matches()) {
...
//                        else
                            ...
                            if (found == 1) {
                                ...
                                Objects.requireNonNull(pastNotifications.get(pack)).add(n);
                            }
